...
describe('LinegraphComponent', () => {
  ...
  it('should calculate graph', () => {
    ...
    expect(component.svgPath).toEqual('M92.5 108.88888888888889 L92.5 108.88888888888889 C297.5 108.88888888888889 442.5 77.77777777777777 462.5 77.77777777777777 C482.5 77.77777777777777 627.5 15.555555555555557 647.5 15.555555555555557 L647.5 140 L92.5 140 Z');
  });
  ...
  it('should calculate trend', () => {
    ...
    expect(component.svgPath).toEqual('M92.5 77.77777777777777 L92.5 77.77777777777777 C297.5 77.77777777777777 442.5 55.55555555555556 462.5 55.55555555555556 C482.5 55.55555555555556 627.5 11.111111111111114 647.5 11.111111111111114 L647.5 100 L92.5 100 Z');
  });
