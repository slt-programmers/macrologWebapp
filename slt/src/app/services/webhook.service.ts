...
export class WebhookService {
	...
	public getWebhookStatus(connectedApp: string) {
		return this.http.get<WebhookStatus>(this.macrologBackendUrl + '/' + connectedApp, { responseType: 'json' });
	}
	...
	public startWebhook(connectedApp: string) {
		...
		return this.http.post(this.macrologBackendUrl + '/' + connectedApp, postData, options);
	}
