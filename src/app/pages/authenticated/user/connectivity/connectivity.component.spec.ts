...
describe('ConnectivityComponent', () => {
  ...
  it('should init connectivity component succesful', fakeAsync(() => {
    ...
    expect(component.stravaConnectUrl).toEqual(
      'http://www.strava.com/oauth/authorize?approval_prompt=force&scope=activity:read_all&response_type=code&state=STRAVACONNECT&client_id=43&redirect_uri=http://localhost:4200/dashboard/user/connectivity'
    );
  }));
