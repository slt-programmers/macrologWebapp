...
export class SliderComponent implements AfterViewInit, OnChanges {
  ...
  private track: any;
  private lowerMark: any;
  private baseMark: any;
  private upperMark: any;
  ...
  private initHandle() {
    ...
    if (this.sliderHandle && this.track) {
      this.sliderHandle.style.left =
        ...
        this.sliderHandle.clientWidth / 2 +
        'px';
  ...
  public onMove(event: any): void {
    ...
    if (this.mouseDown && this.isInBoundary(location)) {
      ...
      this.sliderHandle.style.left =
        this.sliderHandle.offsetLeft - distance + 'px';
  ...
  public onClick(event: any): void {
    ...
    if (this.isInBoundary(location)) {
      ...
      this.sliderHandle.style.left =
        this.newXChord - this.sliderHandle.clientWidth / 2 + 'px';
  ...
  private getMouseLocation(event: any): number {
    let location;
  ...
  private getOffsetLeft(slider: any) {
    let offsetLeft = 0;
    do {
